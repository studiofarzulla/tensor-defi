...
Assets (whitepapers) & 8 \\
Assets (common intersection) & 8 \\
...
We collect whitepapers for 8 assets where official foundational documents are publicly available and extractable: AAVE, AR, AVAX, BTC, ETH, FIL, ICP, and SOL. PDF text is extracted using PyPDF2 with sentence-level tokenization. Table~\ref{tab:whitepaper_corpus} summarizes corpus statistics.
...
AR & 15 & 2,241 & 8 \\
\midrule
\textbf{Total} & 481 & 71,695 & 192 \\
\bottomrule
\end{tabular}
\end{table}

The intersection of whitepaper and market data yields 7 common assets for alignment analysis (AR lacks sufficient market data coverage in our sample).
...
\begin{itemize}
    \item Whitepaper corpus covers only 8 assets with extractable foundational documents, limiting statistical power. Expanding to 50+ projects would enable more robust inference.
...
Table~\ref{tab:whitepaper_corpus_full} provides detailed information about the 8 whitepapers with extractable content analyzed in our study.
...
\midrule
ICP & Tech Overview & 2021 & 45 & 19,695 & 132 \\
FIL & Tech Report & 2017 & 36 & 15,711 & 98 \\
ETH & Whitepaper & 2014 & 36 & 13,632 & 95 \\
SOL & Whitepaper & 2018 & 32 & 7,454 & 50 \\
AVAX & Consensus & 2020 & 14 & 6,382 & 46 \\
BTC & Original WP & 2008 & 9 & 3,452 & 23 \\
AAVE & Protocol WP & 2020 & 12 & 3,128 & 22 \\
AR & Yellowpaper & 2019 & 8 & 2,241 & 15 \\
\midrule
\textbf{Total} & & & \textbf{192} & \textbf{71,695} & \textbf{481} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{@{}p{1.6cm}p{3.2cm}p{1.8cm}@{}}
\toprule
