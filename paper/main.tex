...
\toprule
\textbf{Asset} & \textbf{Type} & \textbf{Year} & \textbf{Pg} & \textbf{Words} & \textbf{Chunks} \\
\midrule
AAVE & Protocol WP & 2020 & 15 & 4,521 & 12 \\
ALGO & Tech Paper & 2019 & 22 & 7,832 & 21 \\
AR & Yellowpaper & 2019 & 18 & 5,643 & 15 \\
ATOM & Whitepaper & 2019 & 24 & 8,234 & 22 \\
AVAX & Consensus & 2020 & 16 & 5,123 & 14 \\
BTC & Original WP & 2008 & 9 & 3,442 & 9 \\
DOT & Lightpaper & 2020 & 12 & 3,876 & 10 \\
ENS & Docs & 2021 & 8 & 2,543 & 7 \\
ETH & Whitepaper & 2014 & 36 & 12,453 & 33 \\
FIL & Tech Report & 2017 & 32 & 11,234 & 30 \\
ICP & Tech Overview & 2021 & 28 & 9,876 & 26 \\
SOL & Whitepaper & 2018 & 20 & 6,543 & 17 \\
UNI & V2 WP & 2020 & 11 & 3,234 & 9 \\
\midrule
...
\begin{tabular}{@{}p{1.8cm}p{3.8cm}p{2.2cm}@{}}
\toprule
\textbf{Category} & \textbf{Definition} & \textbf{Keywords} \\
\midrule
store\_of\_value & Wealth preservation, inflation hedge, reserve asset & gold, hedge, savings \\
\addlinespace
medium\_of\_exchange & Everyday transactions, payments, commerce & payment, currency, spend \\
\addlinespace
smart\_contracts & Programmable self-executing contracts & contract, dApp, EVM \\
\addlinespace
defi & Lending, borrowing, trading, yield & lending, liquidity, AMM \\
\addlinespace
governance & Token voting, protocol control, DAOs & vote, DAO, treasury \\
\addlinespace
scalability & Throughput: L2s, sharding, parallel & throughput, rollup, shard \\
\addlinespace
privacy & Transaction confidentiality, anonymity & anonymous, zkSNARK \\
\addlinespace
interoperability & Cross-chain, bridges, multi-chain & bridge, IBC, relay \\
\addlinespace
data\_storage & Decentralized file storage, archival & storage, IPFS, file \\
\addlinespace
oracle & External data feeds, off-chain compute & oracle, feed, Chainlink \\
\bottomrule
\end{tabular}
\end{table}
